 ...
 */
#define FUNC_DESC_1 "Create array by alloc, init and return functions."
#define FUNC_DESC_2 "Destroy array, created by alloc and init or return."
#define FUNC_DESC_3 "Change array capacity by using different methods."
...
{
	{ MST_TFSTRINGIFY(mst_array_create),  FUNC_DESC_1, MST_TFNODATA },
	{ MST_TFSTRINGIFY(mst_array_destroy), FUNC_DESC_2, MST_TFNODATA },
	{ MST_TFSTRINGIFY(mst_array_realloc), FUNC_DESC_3, MST_TFNODATA },
	{ MST_TFLASTRECORD }
};
...
// typedef struct SMSTST_ARRAY_DATA
// {
// 	MS_ARRAY *Pointer;
// 	MS_ARRAY *PointerCopy;
// 	MS_ARRAY  Local;
...
//  */
// static MunitResult mstst_array_create( const MunitParameter params[], void *argptr )
// {
// 	MSTST_ARRAY_DATA *data   = argptr;
// 	int               ercode = 0;

// 	/* tworzenie dwoma sposobami */
// 	data->Pointer = ms_array_alloc( sizeof(long double), 2 );
// 	data->Local   = ms_array_return_local( sizeof(long double), 2 );

// 	/* inicjalizacja */
// 	ercode = ms_array_init( &data->LocalCopy, sizeof(long double), 2 );

// 	munit_assert_not_null( data->Pointer );
// 	munit_assert_not_null( data->Pointer->Items );
// 	munit_assert_not_null( data->Local.Items );
// 	munit_assert_not_null( data->LocalCopy.Items );
	
// 	/* tylko tablice utworzone w pamięci mogą być usuwane w całości */
// 	munit_assert( data->Pointer->Destroy );
// 	munit_assert( !data->Local.Destroy );
// 	munit_assert( !data->LocalCopy.Destroy );

// 	/* taki rozmiar został ustawiony przy tworzeniu */
// 	munit_assert_size ( data->Pointer->Capacity,  ==, 2 );
// 	munit_assert_size ( data->Local.Capacity,     ==, 2 );
// 	munit_assert_size ( data->LocalCopy.Capacity, ==, 2 );

// 	/* długość jest 0, gdyż nie ma jeszcze żadnego elementu */
// 	munit_assert_size ( data->Pointer->Length,  ==, 0 );
// 	munit_assert_size ( data->Local.Length,     ==, 0 );
// 	munit_assert_size ( data->LocalCopy.Length, ==, 0 );

// 	/* rozmiar elementu został podany przy tworzeniu, ma być taki sam */
// 	munit_assert_size ( data->Pointer->ItemSize,  ==, sizeof(long double) );
// 	munit_assert_size ( data->Local.ItemSize,     ==, sizeof(long double) );
// 	munit_assert_size ( data->LocalCopy.ItemSize, ==, sizeof(long double) );

// 	/* początkowa funkcja odpowiadająca za zwiększanie */
// 	munit_assert_ptr  ( data->Pointer->FuncIncrease,  ==, MSC_ArrayFunctions.IncMultiply );
// 	munit_assert_ptr  ( data->Local.FuncIncrease,     ==, MSC_ArrayFunctions.IncMultiply );
// 	munit_assert_ptr  ( data->LocalCopy.FuncIncrease, ==, MSC_ArrayFunctions.IncMultiply );

// 	/* początkowy modyfikator */
// 	munit_assert_float( data->Pointer->Modifier,  ==, 2.f );
// 	munit_assert_float( data->Local.Modifier,     ==, 2.f );
// 	munit_assert_float( data->LocalCopy.Modifier, ==, 2.f );
...
//  * Sprawdza czy tworzenie tablicy przebiega prawidłowo.
//  */
// static MunitResult mstst_array_destroy( const MunitParameter params[], void *argptr )
// {
// 	MSTST_ARRAY_DATA *data = argptr;
...
// 	ms_array_free( data->Pointer );
// 	munit_assert_null( data->Pointer->Items );

// 	ms_array_free( &data->LocalCopy );
// 	munit_assert_null( data->LocalCopy.Items );
...
// {
// 	{ "ms_array_create",  mstst_array_create,  NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
// 	{ "ms_array_destroy", mstst_array_destroy, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
...
// #define MSTST_ARRAY_LOCAL_EMPTY { 0, 0, 0, 0.f, FALSE, NULL, NULL }
...
// 		NULL,
// 		NULL,
// 		MSTST_ARRAY_LOCAL_EMPTY,
// 		MSTST_ARRAY_LOCAL_EMPTY
// 	};
// 	return munit_suite_main( &test_suite, &data, argc, argv );
// }
